...
console.log("Aplicando la función Find para encontrar el taller de la Ing. María López")
const tallerMaria = talleres.find((t) => t.instructor === 'Ing. María López')
console.log(tallerMaria.nombre)
...
console.log("Aplicando la función Filter y Map encadenadas para obtener los talleres con cupo disponible")
